...
function st_merge_coverage_2()
{
	...
	{
	    this.do_fsobj_create_file("dir_2/dir_22/file_xxx");
	    this.do_chmod("dir_2/dir_22/file_xxx", 0700);
	    // TODO need example entry with XATTR
	    // TODO need example SYMLINK
	}
        this.do_addremove_scan();
	this.do_vc_rename("dir_0", "dir_0_renamed");
	this.do_vc_rename("dir_0_renamed/dir_00/", "dir_00_renamed");
	this.do_vc_rename("dir_0_renamed/dir_00_renamed/file_000", "file_000_renamed");
	...
	expect_test["Renamed"] = [ "@/dir_0_renamed",
				   "@/dir_0_renamed/dir_00_renamed",
				   "@/dir_0_renamed/dir_00_renamed/file_000_renamed" ];
	if ((sg.platform() == "LINUX") || (sg.platform() == "MAC"))
	{
	    expect_test["Added"].push( "@/dir_2/dir_22/file_xxx" );
	}
        this.confirm_when_ignoring_ignores(expect_test);
    }
