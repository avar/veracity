 ...
 * @endcopyright
 *
 * @file sg_apple_unicode__private_sys_utfconv.h
 *
 ...
 *
 * EVERYTHING IN THIS FILE IS DECLARED static.
 * IT SHOULD ONLY BE INCLUDED BY sg_apple_unicode.c
 */
...
#ifndef H_SG_APPLE_UNICODE__PRIVATE_SYS_UTFCONV_H
#define H_SG_APPLE_UNICODE__PRIVATE_SYS_UTFCONV_H
...
#endif//H_SG_APPLE_UNICODE__PRIVATE_SYS_UTFCONV_H
