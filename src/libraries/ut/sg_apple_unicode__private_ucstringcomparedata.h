 ...
 * @endcopyright
 *
 * @file sg_apple_unicode__private_ucstringcomparedata.h
 *
...
#ifndef H_SG_APPLE_UNICODE__PRIVATE_UCSTRINGCOMPAREDATA_H
#define H_SG_APPLE_UNICODE__PRIVATE_UCSTRINGCOMPAREDATA_H
 ...
 */
static u_int16_t gLatinCaseFold[] = {
	...
	// BUGBUG I know this table was taken from Apple's source, but are the values for rows C and D correct?
	// BUGBUG Shouldn't many (but not all) of the values in row C should list the corresponding value in row E?
	// BUGBUG Likewise, shouldn't many (but not all) of the values in row D should list values in row F?
...
static u_int16_t gLowerCaseTable[] = {
...
#endif//H_SG_APPLE_UNICODE__PRIVATE_UCSTRINGCOMPAREDATA_H
